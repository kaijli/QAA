...
```{r out.width="80%", fig.align="center", fig.cap="Fig 1. Per Base N Content of 4_2C_mbnl_S4_L008_R1 from FastQC"}
knitr::include_graphics("fastqc_results/4_2C_mbnl_S4_L008_R1_001_fastqc/Images/per_base_n_content.png")
```

```{r out.width="80%", fig.align="center", fig.cap="Fig 2. Per Base Quality of 4_2C_mbnl_S4_L008_R1 from FastQC"}
knitr::include_graphics("fastqc_results/4_2C_mbnl_S4_L008_R1_001_fastqc/Images/per_base_quality.png")
```

```{r out.width="80%", fig.align="center", fig.cap="Fig 3. Per Base N Content of 4_2C_mbnl_S4_L008_R2 from FastQC"}
knitr::include_graphics("fastqc_results/4_2C_mbnl_S4_L008_R2_001_fastqc/Images/per_base_n_content.png")
```

```{r out.width="80%", fig.align="center", fig.cap="Fig 4. Per Base Quality of 4_2C_mbnl_S4_L008_R2 from FastQC"}
...
```{r out.width="80%", fig.align="center", fig.cap="Fig 5. Python Calculated Per Base Quality of 4_2C_mbnl_S4_L008_R1 from personal python script"}
knitr::include_graphics("4_2C_mbnl_S4_L008_R1_hist.png")
```

```{r out.width="80%", fig.align="center", fig.cap="Fig 6. Python Calculated Per Base Quality of 4_2C_mbnl_S4_L008_R2 from personal python script"}
...
```{r out.width="80%", fig.align="center", fig.cap="Fig 7. Trimmed Read Length Distributions for 4_2C_mbnl_S4_L008 R1 and R2 from personal python script after running cutadapt and trimmomatic"}
